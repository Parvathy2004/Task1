...
name_entry.configure(state="disabled")
name_entry.bind("<Button-1>", lambda event: on_click(name_var,name_entry,name_placeholder))
name_entry.bind("<FocusOut>", lambda event: on_focusout(name_var,name_entry,name_placeholder))
...
sub_btn = tk.Button(mainframe, text="Submit", command= submit)
